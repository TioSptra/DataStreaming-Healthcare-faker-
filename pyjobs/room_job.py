...
SINK_TOPIC = "room_data"

def main():
    env_settings = EnvironmentSettings.in_streaming_mode()
    t_env = StreamTableEnvironment.create(environment_settings=env_settings)

    t_env.get_config().set("pipeline.name", "Treatment Tumbling Window Room Aggregation ")
    ...
    t_env.execute_sql(f"""
        CREATE TABLE room_occupancy_sink (
    ...
    t_env.execute_sql("""
        INSERT INTO room_occupancy_sink
        SELECT
            window_start,
            window_end,
            room,
